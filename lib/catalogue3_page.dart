...
class Catalogue3Page extends StatefulWidget {
  const Catalogue3Page({super.key});

  @override
  _Catalogue3PageState createState() => _Catalogue3PageState();
}

class _Catalogue3PageState extends State<Catalogue3Page> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Catalogue 3 Page'),
      ),
