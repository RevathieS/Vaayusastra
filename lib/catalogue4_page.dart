...
class Catalogue4Page extends StatefulWidget {
  const Catalogue4Page({super.key});

  @override
  _Catalogue4PageState createState() => _Catalogue4PageState();
}

class _Catalogue4PageState extends State<Catalogue4Page> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Catalogue 4 Page'),
      ),
